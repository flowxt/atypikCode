      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <div>
            ...
            <p className="text-gray-400">Sites web professionnels en Haute-Savoie</p>
          </div>
          
          <div className="flex gap-4">
            <a href="https://www.linkedin.com/in/florian-barjon-497a27324/" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full border border-white/10 hover:bg-white/5 transition-all">
            ...
            <a href="https://github.com/flowxt" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full border border-white/10 hover:bg-white/5 transition-all">
              <svg className="w-5 h-5 text-gray-400 hover:text-white transition-all" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="mt-10 pt-10 border-t border-white/5 text-center">
          <p className="text-gray-500 mb-3">© 2025 - Tous droits réservés | Créé avec passion en Haute-Savoie</p>
